...
export default defineComponent({
  ...
  methods: {
    changeFilter(strFilter: string) {
      console.log("changeFilter", strFilter);
      this.filterCategory = strFilter;
    },
    changeSort(sortColumnf: string, sortDirectionf: string) {
      this.sortColumn = sortColumnf;
      this.sortDirection = sortDirectionf;
    },
  },
});
</script>
